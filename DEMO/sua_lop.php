    ...
    <div class="container-fluid">
        <div class="row content">
            ...
            <div class="col-sm-9"><br>
                ...
                <h2 style="text-align: center; font-size: 30px; font-weight: bold;">Tìm lớp để sửa</h2>

                <?php
                if (isset($_SESSION['message'])) { // Kiểm tra nếu có thông báo trong session
                    echo "<div class='alert alert-" . $_SESSION['msg_type'] . "'>" . htmlspecialchars($_SESSION['message']) . "</div>"; // Hiển thị thông báo
                    unset($_SESSION['message']); // Xóa thông báo khỏi session
                    unset($_SESSION['msg_type']); // Xóa loại thông báo khỏi session
                }
                ?>

                <form action="form_sua_lop.php" method="get">
                    <div class="form-group">
                        <label for="maLop">Nhập mã lớp:</label>
                        <input type="text" class="form-control" id="maLop" name="ma" placeholder="Nhập mã lớp" required>
                    </div>
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary">Tìm lớp</button>
                    </div>
                </form>
            </div>
        </div>
