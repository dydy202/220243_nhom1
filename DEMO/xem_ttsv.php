...
<body>
    <div class="container-fluid">
        <div class="row content">
            <div class="col-sm-3 left-column" style="width: 20%; height: 120vh;">
            ...
            <div class="col-sm-9"><br>
                ...
                <div class="col-sm-10" style="margin: 0 auto; float: none;"><br>
                    ...
                    <a href="export_student_excel.php?maSV=<?php echo urlencode($maSV); ?>" class="btn btn-success">
                        <i class="fas fa-file-excel"></i> Export to Excel
                    </a>

                    <a href="export_student_pdf.php?maSV=<?php echo urlencode($maSV); ?>" class="btn btn-success">
                        <i class="fas fa-file-excel"></i> Export to PDF
                    </a>
