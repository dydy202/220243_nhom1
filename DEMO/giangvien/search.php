        ...
        <div class="row content">
            <div class="col-sm-3 left-column" style="width: 20%;  min-height: 200px;">
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="#" class="btn btn-default" onclick="alert('Bạn không có quyền truy cập!');">Thêm
                            lớp</a></li>
                    <li><a href="#" class="btn btn-default" onclick="alert('Bạn không có quyền truy cập!');">Sửa lớp</a>
                    </li>
                    <li><a href="#" class="btn btn-default" onclick="alert('Bạn không có quyền truy cập!');">Xóa lớp</a>
                    </li>
                </ul>
                ...
                <h4>Thùng rác</h4>
                <ul class="nav nav-pills nav-stacked">
                    <li><a href="#" class="btn btn-default" onclick="alert('Bạn không có quyền truy cập!');">Xem danh
                            sách lớp đã xóa</a></li>
